...
@WebAppConfiguration
@ContextConfiguration(locations={"classpath:applicationContext.xml","file:D:\\SSMCURD\\src\\main\\webapp\\WEB-INF\\dispatcherServlet-servlet.xml"})
public class MvcTest {
    ...
    public void testPage() throws Exception {
        ...
        //请求成功以后，请求域中会有pageInfo,我们可以区出pageInfo进行验证
        MockHttpServletRequest request=mvcResult.getRequest();
        PageInfo pi=(PageInfo)request.getAttribute("pageInfo");
        System.out.println("当前页码："+pi.getPageNum());
        System.out.println("当前码："+pi.getPages());
